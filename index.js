    ...
    _checkRecord(rec) {
        ...
        rec.addedNodes.forEach(n => {
            if(n.classList && n.classList.contains('popout')){
                if(n.childNodes[0].classList.contains('userPopout-4pfA0d')) this.emit('userPopout', window.DI.getReactInstance(n.childNodes[0])._currentElement.props.children[1].props.children[1][1].props.user);
